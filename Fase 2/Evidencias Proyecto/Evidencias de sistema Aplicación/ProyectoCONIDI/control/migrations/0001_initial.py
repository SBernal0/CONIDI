...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='HistoricalCategoriaAlergia',
            fields=[
            ...
            options={
                'verbose_name': 'historical Categoría de Alergia',
                'verbose_name_plural': 'historical Categorías de Alergias',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mecanismo_inmunitario', models.CharField(choices=[('TIPO_I', 'Tipo I (Inmediata, IgE)'), ('TIPO_II', 'Tipo II (Citotóxica, IgG/IgM)'), ('TIPO_III', 'Tipo III (Inmunocomplejos)'), ('TIPO_IV', 'Tipo IV (Retardada, Celular)'), ('NO_ESPECIFICADO', 'No Especificado / Desconocido')], default='NO_ESPECIFICADO', max_length=50, verbose_name='Mecanismo Inmunitario')),
            ...
            options={
                'verbose_name': 'historical Registro de Alergia',
                'verbose_name_plural': 'historical Registros de Alergias',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
